...
# sender2 -----
    ...
    net.addLink(sender1, router, bw=12, delay='5ms')
    net.addLink(sender2, router, bw=12, delay='5ms')
    net.addLink(router, receiver, bw=.3, delay='5ms')
    ...
    # RED
    router.cmd('tc qdisc add dev router-eth2 root handle 1: red limit 100000 min 30000 max 90000 avpkt 1000 burst 20 probability 0.02')
